...
lambda_layer_name=impleter-converters-lambda-packages
lambda_function_array=( class-crude-label-converter ner-crude-label-converter ner-label-train-converter squad-crude-label-converter squad-label-train-converter )

s3_bucket=$LAMBDA_PACKAGES_S3_BUCKET
lambda_layer_s3_key=$IMPLETER_CONVERTERS_LAMBDA_LAYER_ZIP_S3_KEY
lambda_s3_key=$IMPLETER_CONVERTERS_SOURCE_ZIP_S3_KEY
